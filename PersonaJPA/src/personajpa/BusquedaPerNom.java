...
public class BusquedaPerNom extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            jTextField7.setText("");
            jTextField8.setText("");
            JOptionPane.showMessageDialog(rootPane, "Persona no encontrada en el sistema");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaPerNom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
